...
-- Exportiere Daten aus Tabelle krautundrueben.bestellung: ~0 rows (ungefähr)
...
CREATE TABLE IF NOT EXISTS `rezepte` (
  ...
  `High_Prot` int(11) DEFAULT NULL,
  `Glutenfrei` int(11) DEFAULT NULL,
  `Laktosefrei` int(1) DEFAULT NULL,
  `enthaelt_keine_nuesse` int(1) DEFAULT NULL,
  `enthaelt_kein_ei` int(1) DEFAULT NULL,
  `allesfresser` int(1) DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `rezepte` (`ID`, `Name`, `Vegetarisch`, `Vegan`, `High_Prot`, `Glutenfrei`, `Laktosefrei`, `enthaelt_keine_nuesse`, `enthaelt_kein_ei`, `allesfresser`) VALUES
	(1, 'Bunter Salat', 1, 1, NULL, 1, 1, 1, 1, 1),
	(2, 'Orientalische Lammkoteletts', NULL, NULL, 1, NULL, NULL, 1, NULL, 1),
	(3, 'English Breakfast', NULL, NULL, 1, NULL, NULL, 1, NULL, 1),
	(4, 'Tomate-Mozzarella', 1, NULL, NULL, 1, NULL, 1, NULL, 1),
	(5, 'Ofengemüse', 1, NULL, NULL, NULL, NULL, 1, NULL, 1);
